...
namespace SHA
{
    public class Class1
    {
        public bool SignSHA256(string pfxCert, string certPassWd, string SignString, ref string hashOfString, ref string signature)
        {
            var hash = new System.Text.StringBuilder();
            Byte[] certificate = File.ReadAllBytes(pfxCert);
            X509Certificate2 cert2 = new X509Certificate2(certificate, certPassWd, X509KeyStorageFlags.Exportable);
